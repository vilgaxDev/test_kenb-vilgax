		...
		<div class="modal-content">
			<div align="right">
				...
				<c:if test="${amountError != 'NULL'}">
						<h4 style="color: red">${amountError}</h4>
					</c:if>
			...
			<div class="modal-body">
				<form:form method="post" modelAttribute="loanEMIForm"
					action="/payPersonalEMI">
					<div class="form-group">
						<form:input type="text" class="form-control"
							placeholder="Enter Account Number" path="loanAccountNumber" required="required" />
					</div>
					<div class="form-group">
						<form:input type="text" class="form-control"
							placeholder="Enter Amount" path="loanEMI" required="required" />
					</div>
					<div class="form-group"> 
						<button type="submit"
